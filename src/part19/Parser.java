...
import part19.ast.Assign;
import part19.ast.BinOp;
import part19.ast.Block;
import part19.ast.Compound;
import part19.ast.NoOp;
import part19.ast.Num;
import part19.ast.Param;
import part19.ast.ProcedureCall;
import part19.ast.ProcedureDecl;
import part19.ast.Program;
import part19.ast.UnaryOp;
...
public class Parser {
	...
	private List<Param> formal_parameters() {
		...
		consume(Type.COLON);
		part19.ast.Type type = type_spec();
     ...
     *           | REAL
	 */
	private part19.ast.Type type_spec() {
		Token token = current;
		if (is(Type.INTEGER))
			consume(Type.INTEGER);
		else
			consume(Type.REAL);
		return new part19.ast.Type(token);
	}
